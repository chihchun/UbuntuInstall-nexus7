...
public class UbuntuEditTextPreference extends EditTextPreference {

	public UbuntuEditTextPreference(Context context) {
		super(context);
	}

	public UbuntuEditTextPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public UbuntuEditTextPreference(Context context, AttributeSet attrs, int defStyle) {
